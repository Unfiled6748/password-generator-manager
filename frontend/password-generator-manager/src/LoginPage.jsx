          ...
          <div className="md:max-w-md w-full px-4 py-4">
            <form>
              <div className="mb-12">
                ...
                <p className="text-sm mt-4 text-gray-800">Don't have an account <a href="/signup" className="text-teal-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
              </div>

              <div>
                <label className="text-gray-800 text-xs block mb-2">Username</label>
                <div className="relative flex items-center">
                  <input name="username" type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter username" value={username} onChange={(e) => (setUsername(e.target.value), setUser(e.target.value))} />
...
*/}
              ...
              <div className="mt-12">
                <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-teal-600 hover:bg-teal-900 focus:outline-none" onClick={handleLogin}>
                  Sign in
                </button>
              </div>
